...
const MyToys = () => {
  ...
  const shownRowCount = showAll
    ? displayedToys.length
    : Math.min(displayedToys.length, 20);
      ...
      <div className="my-10 mx-16">
        ...
        <div className="overflow-x-auto w-full mt-3">
          <table className="table w-full">
            ...
            <tbody>
              {/* row 1 */}
              {displayedToys.slice(0, shownRowCount).map((toy) => (
                <tr key={toy._id}>
                  <td>
                  ...
                  <td className="tooltip" data-tip={toy.toyName}>
                    {toy.toyName.length > 25
                      ? toy.toyName.substring(0, 25) + "...."
                      : toy.toyName}
                  </td>
                  ...
                  <th class="flex flex-col gap-1">
                    <div className="btn-group">
                      ...
                      <button
                        ...
                        className="btn btn-xs btn-error tooltip font-bold rounded-md"
                        data-tip="Delete"
                      >
                        X
                      </button>
