        ...
        <div>
            <div className="carousel w-full">
                <div id="slide1" className="carousel-item relative w-full">
                    ...
                    <div className="hero min-h-screen" style={{ backgroundImage: `url("/slider-1.jpg")` }}>
                ...
                <div id="slide2" className="carousel-item relative w-full">
                    ...
                    <div className="hero min-h-screen" style={{ backgroundImage: `url("/slider-2.jpg")` }}>
                        <div className="hero-overlay bg-opacity-60"></div>
                        <div className="hero-content text-center text-neutral-content">
                            <div className="max-w-md">
                ...
                <div id="slide3" className="carousel-item relative w-full">
                    ...
                    <div className="hero min-h-screen" style={{ backgroundImage: `url("/slider-3.jpg")` }}>
                        <div className="hero-overlay bg-opacity-60"></div>
                        <div className="hero-content text-center text-neutral-content">
                            <div className="max-w-md">
                ...
                <div id="slide4" className="carousel-item relative w-full">
                    ...
                    <div className="hero min-h-screen" style={{ backgroundImage: `url("/slider-4.jpg")` }}>
                        <div className="hero-overlay bg-opacity-60"></div>
                        <div className="hero-content text-center text-neutral-content">
                            <div className="max-w-md">
