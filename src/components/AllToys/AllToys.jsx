...
const AllToys = () => {
  ...
  const shownRowCount = showAll
    ? filteredToys.length
    : Math.min(filteredToys.length, 20);
    ...
    <div className="my-10 mx-16">
      ...
      <div className="overflow-x-auto w-full mt-3">
        <table className="table w-full">
          ...
          <tbody>
            {/* row 1 */}
            {filteredToys.slice(0, shownRowCount).map((toy) => (
              <tr key={toy._id}>
                <td>
                ...
                <td className="tooltip tooltip-lg" data-tip={toy.toyName}>
                  {toy.toyName.length > 20
                    ? toy.toyName.substring(0, 20) + "......"
                    : toy.toyName}
                </td>
