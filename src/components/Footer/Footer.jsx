        ...
        <div>
            <footer className="footer p-10 bg-[#570df816]  text-base-content">
                ...
                <div>
                    ...
                    <a className="link link-hover">Robert Robertson, PixiePlay</a>
                    <a className="link link-hover">1234 NW Bobcat Lane</a>
                    <a className="link link-hover">St. Robert, MO 65584-5678.</a>
                </div>
                <div>
                    ...
                    <div>
                        Copyright © PixiePlay Ltd. 2023 - All right reserved
                    </div>
                </div>
            </footer>
